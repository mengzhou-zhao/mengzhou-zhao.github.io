...
summary: >-
  <div class="mb-3 pl-3" style="border-left: 3px solid #ced4da;">
    <p class="mb-1"><strong>Problem</strong> &mdash; The design space is large with competing goals (bending vs. torsional stiffness vs. how compactly the wing folds), and every high-fidelity FE evaluation is expensive.</p>
    ...
    <p class="mb-0"><strong>Impact</strong> &mdash; Delivers a validated Pareto front and, via Sobol analysis, shows which geometric variables drive performance &mdash; turning trial-and-error design into a systematic, evidence-anchored process.</p>
  </div>
...
summary_zh: >-
  <div class="mb-3 pl-3" style="border-left: 3px solid #ced4da;">
    <p class="mb-1"><strong>问题</strong> &mdash; 设计空间庞大且目标彼此竞争（弯曲刚度、扭转刚度与机翼折叠紧凑度），而每次高保真有限元评估都很昂贵。</p>
    <p class="mb-1"><strong>我的角色</strong> &mdash; 我构建了整套计算优化框架——Abaqus 梁有限元、代理模型、自适应填充循环与遗传多目标搜索——并与实验标定。</p>
    <p class="mb-0"><strong>成果与应用</strong> &mdash; 给出经验证的 Pareto 前沿，并借助 Sobol 分析指出哪些几何变量主导性能——把试错式设计转化为系统化、以证据为锚的流程。</p>
  </div>
