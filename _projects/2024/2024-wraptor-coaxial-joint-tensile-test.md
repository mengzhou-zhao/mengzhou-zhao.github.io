---
title:      "WrapToR Truss Coaxial Joint: Tensile Testing and Node Reinforcement"
title_zh:   "WrapToR 桁架同轴节点：拉伸试验与节点加强"
date:       2024-03-01 00:01:00 +0800
selected:   true
role:       "PhD Research"
role_zh:    "博士研究"
cover:      /assets/images/covers/wraptor-coaxial-joint-test.jpg
tags:
  - Composites
  - Filament Winding
  - Mechanical Testing
...
summary: >-
  ...
  <div class="row mt-2 no-gutters">
    ...
    <div class="col-6 pl-1">
      <img src="/assets/images/covers/wraptor-coaxial-joint-results.png" class="w-100 rounded-sm mb-1" alt="Bar chart comparing average failure load of normal vs reinforced coaxial joints">
      <div class="small text-center text-muted">Failure load: unreinforced vs. reinforced</div>
    </div>
  </div>
summary_zh: >-
  <div class="mb-3 pl-3" style="border-left: 3px solid #ced4da;">
  ...
  <div class="row mt-2 no-gutters">
    <div class="col-6 pr-1">
      <img src="/assets/images/covers/wraptor-coaxial-joint-jig.jpg" class="w-100 rounded-sm mb-1" alt="Bonding jig for the coaxial joint tensile test specimens">
      <div class="small text-center text-muted">试样粘接用夹具</div>
    </div>
    <div class="col-6 pl-1">
      <img src="/assets/images/covers/wraptor-coaxial-joint-results.png" class="w-100 rounded-sm mb-1" alt="Bar chart comparing average failure load of normal vs reinforced coaxial joints">
      <div class="small text-center text-muted">失效载荷：未加强 vs. 加强</div>
    </div>
  </div>
---
