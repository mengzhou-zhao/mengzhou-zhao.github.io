...
summary: >-
  <div class="mb-3 pl-3" style="border-left: 3px solid #ced4da;">
    <p class="mb-1"><strong>Problem</strong> &mdash; A lightweight truss is only as good as its joints, yet joints are usually metal brackets or bonded fittings that add mass and become failure points &mdash; and no manufacturing route existed to build a whole truss joint as one continuous composite part.</p>
    ...
    <p class="mb-0"><strong>Impact</strong> &mdash; A 17.85&nbsp;g all-composite joint made in a single continuous wind, with member stiffness tunable by pass count &mdash; the manufacturing foundation for lightweight modular space frames.</p>
  </div>
  ...
  <div class="row mt-2 no-gutters">
    <div class="col-6 pr-1">
      ...
      <div class="small text-center text-muted">Tow catcher: two-armed tow-capture geometry</div>
    </div>
...
summary_zh: >-
  <div class="mb-3 pl-3" style="border-left: 3px solid #ced4da;">
    <p class="mb-1"><strong>问题</strong> &mdash; 轻量化桁架的性能取决于其节点，而节点通常是增重且易失效的金属支架或粘接件；此前没有任何工艺能把整个桁架节点作为一个连续的复合材料零件一次成型。</p>
    <p class="mb-1"><strong>我的角色</strong> &mdash; 我从头到尾开发了这套三维缠绕工艺，并设计了实现它的关键工装——3D 打印"捕束器"，还亲手缠绕出第一个可用的同轴节点。</p>
    <p class="mb-0"><strong>成果与应用</strong> &mdash; 一次连续缠绕即得 17.85&nbsp;g 全复合材料节点，杆件刚度可按缠绕道数调节——为轻量化模块化空间框架奠定了制造基础。</p>
  </div>
