...
images:
  - src: /assets/images/covers/wraptor-coaxial-joint-tow-catcher.png
    alt: "3D-printed two-armed tow catcher gripping carbon tow against the joint tubes"
  - src: /assets/images/covers/wraptor-coaxial-joint-node-cross-section.jpg
    alt: "Sectioned view of a joint node with the printed tow catcher seated over the tow, pressing it flat against the members"
    caption: "Sectioned at the node: the printed arm sits over the tow and holds it flat against the members, so the fibre turns the corner in contact instead of bridging across it."
    caption_zh: "在节点处剖开：打印件压在纤维束上、将其压平贴合杆件，使纤维在转角处始终保持接触，而不是凌空跨过。"
---
<div>
    <div class="p-3">
